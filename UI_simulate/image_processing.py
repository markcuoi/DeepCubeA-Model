...
def output(total):
    ...
    clear = open("/home/mark/Desktop/Cube/Rubik/Rubik/UI_simulate/cube_test.txt","r+")
    clear.truncate(0)
    clear.close()
    total_temp = []
    for i in total:
    ...
    with open("/home/mark/Desktop/Cube/Rubik/Rubik/UI_simulate/cube_test.txt", "a+") as write_output:
