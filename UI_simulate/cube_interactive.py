...
import pickle
import time
from model.astar import SolveRubik
from image_processing import *
#from model.astar import *
class Cube:
...
class InteractiveCube(plt.Axes):
    ...
    def _initialize_widgets(self):
        ...
        self._ax_get_image = self.figure.add_axes([0.20, 0.05, 0.2, 0.075])
        self._btn_image = widgets.Button(self._ax_get_image, 'Get Images')
        self._btn_image.on_clicked(self._get_image)
